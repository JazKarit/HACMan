...
from hacman.utils.transformations import transform_point_cloud, to_pose_mat, sample_idx, to_pose_mat, transform_point_cloud, decompose_pose_mat
...
"""
class PushStraightEnv0(BaseEnv):
    def __init__(self,
            object_pcd_size=400,
    ...
    def _evaluate_goal(self, obs, goal):
        ...
        pos_diff = np.linalg.norm(object_pos)
    ...
    **See scripts/test_simple_env.py for visualization.**
    ...
    def reset(self, state=None):
        if state is not None:
            ...
            self.cube_state = np.array([0.0, 0.0])
